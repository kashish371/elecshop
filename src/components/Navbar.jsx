  ...
  return (
    <div >
      ...
      <Flex bg={"#e42529"} color="white">
        ...
        <Flex width="300px">
        <Box cursor="pointer" ><i className="fa-solid fa-location-dot"></i> Select your location</Box>
        <Spacer/>

        <Box cursor="pointer" display="flex" onClick={()=>navigate("/cart")}><i className="fa-solid fa-cart-shopping"></i> 
        {car>0&&<Box style={{width:"25px",height:"25px",borderRadius:"50%",backgroundColor:"black"}}>{car>0?car:""}</Box> }Cart</Box>
        
        <Spacer/>
        <Box onClick={()=>navigate("/login")} cursor="pointer"><i className="fa-solid fa-user"></i> {firstName!==""?firstName:"Login"}</Box>
        <Spacer/>
        </Flex>
        </Flex>
